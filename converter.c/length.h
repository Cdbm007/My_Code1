...
float centi(float er)
{
 ...
 {
  case 1:va=er/100.0;
	 gotoxy(20,10);printf("Centimeter : %.2f--------->Meter : ",er);
	 break;
...
{
 clrscr();
 gotoxy(25,10);printf("Convert %f Kilometers to .......",er);
 ...
 {
  case 1:va=er*1000.0;
	 gotoxy(20,21);printf("Kilometer : %.2f--------->Meter : ",er);
	 break;
  case 2:va=er*100000.0;
	 gotoxy(20,21);printf("Kilometer : %.2f--------->Centimeter : ",er);
	 break;
  case 3:va=er/1.609;
	 gotoxy(20,21);printf("Kilometer : %.2f--------->Mile : ",er);
	 break;
  case 4:va=er/1.852;
	 gotoxy(20,21);printf("Kilometer : %.2f--------->Nautical_Mile : ",er);
	 break;
 }
 return(va);
}
...
{
 clrscr();
 gotoxy(25,10);printf("Convert Miles to .......");
 gotoxy(20,12);printf("1.Meter...........Press 1");
 gotoxy(20,14);printf("2.Centimeter .... Press 2");
 ...
 {
  case 1:va=er*1609.0;
	 gotoxy(20,21);printf("Mile : %.2f--------->Meter : ",er);
	 break;
  case 2:va=er*160934.0;
	 gotoxy(20,21);printf("Mile : %.2f--------->Centimeter : ",er);
	 break;
  case 3:va=er*1.609;
	 gotoxy(20,21);printf("Mile : %.2f--------->Kilometer : ",er);
	 break;
  case 4:va=er/1.151;
	 gotoxy(20,21);printf("Mile : %.2f--------->Nautical_Mile : ",er);
	 break;
 }
 return(va);
}
...
{
 clrscr();
 gotoxy(25,10);printf("Convert Nautical_Miles to .......");
 gotoxy(20,12);printf("1.Meter........Press 1");
 gotoxy(20,14);printf("2.Centimeter...Press 2");
 gotoxy(20,16);printf("3.Kilometer....Press 3");
 ...
 {
  case 1:va=er*1852.0;
	 gotoxy(20,21);printf("Nautical_Mile : %.2f--------->Meter : ",er);
	 break;
  case 2:va=er*185200.0;
	 gotoxy(20,21);printf("Nautical_Mile : %.2f--------->Centimeter : ",er);
	 break;
  case 3:va=er*1.852;
	 gotoxy(20,21);printf("Nautical_Mile : %.2f--------->Kilometer : ",er);
	 break;
  case 4:va=er*1.151;
	 gotoxy(20,21);printf("Nautical_Mile : %.2f--------->Mile : ",er);
	 break;
 }
 return(va);
}
